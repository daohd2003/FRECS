...
namespace DataAccess.Migrations
{
    ...
    [Migration("20251129135046_RenameRentalDaysDiscountToItemRentalCountDiscount")]
    partial class RenameRentalDaysDiscountToItemRentalCountDiscount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObject.Models.IssueResolution", b =>
                {
                    ...
                    b.Property<decimal>("CustomerFineAmount")
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.Property<decimal>("ProviderCompensationAmount")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("BusinessObject.Models.Order", b =>
                {
                    ...
                    b.Property<decimal>("ItemRentalCountDiscount")
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal>("ItemRentalCountDiscountPercent")
            ...
            modelBuilder.Entity("BusinessObject.Models.RentalViolation", b =>
                {
                    ...
                    b.Property<string>("CustomerEscalationReason")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<string>("ProviderEscalationReason")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<string>("ProviderResponseToCustomer")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
            ...
            modelBuilder.Entity("BusinessObject.Models.TryOnImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("GarmentPublicId")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("BusinessObject.Models.Feedback", b =>
                {
                    b.HasOne("BusinessObject.Models.User", "BlockedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessObject.Models.IssueResolution", b =>
                {
                    ...
                    b.HasOne("BusinessObject.Models.RentalViolation", "RentalViolation")
                        .WithOne()
                        .HasForeignKey("BusinessObject.Models.IssueResolution", "ViolationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ProcessedByAdmin");

                    b.Navigation("RentalViolation");
                });
