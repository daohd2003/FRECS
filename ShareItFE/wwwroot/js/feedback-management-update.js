// Updated renderFeedbackDetail function with OrderItem information
        ...
        <div class="detail-section">
            ...
            <div class="product-detail-card">
                ...
                <div style="flex: 1;">
                    ...
                    <p style="margin: 0;"><strong>Base Price:</strong> ${formatCurrency(feedback.product.price)}/day</p>
                    <p style="margin: 0;"><strong>Provider:</strong> ${feedback.product.providerName}</p>
